...
const Messages = () => {
  ...
  useEffect(() => {
    fetch("https://se-tpa-feedbacks-default-rtdb.firebaseio.com/feedback.json").then(
      (result) => {
  ...
  return (
    <div className={styles.registrartion}>
      ...
      <div className={styles.lineParent}>
        ...
        {/* <b className={styles.registerATourWithUs}>Messages</b> */}
        <div className={styles.registration}><b>M E S S A G E S</b></div>
      </div>
      <img
